...
public class ItemMenuService {
    ...
    public ItemMenu updateItemMenu(Long id, ItemMenu itemMenuDetails) {
        ...
        if (itemMenu.isPresent()) {
            ...
            updatedItemMenu.setEsComida(itemMenuDetails.isEsComida());
            updatedItemMenu.setGraduacionAlcoholica(itemMenuDetails.getGraduacionAlcoholica());
            updatedItemMenu.setTam(itemMenuDetails.getTam());
            updatedItemMenu.setPeso(itemMenuDetails.getPeso());
            updatedItemMenu.setCalorias(itemMenuDetails.getCalorias());
            updatedItemMenu.setAptoCeliaco(itemMenuDetails.isAptoCeliaco());
            updatedItemMenu.setAptoVegano(itemMenuDetails.isAptoVegano());
